 ...
 * test/cli.test.ts is excluded: it shells out to `tsx src/cli.ts`, and a
 ...
 * src/cli.ts is therefore mutation-tested by hand, not by Stryker.
 */
export default defineConfig({
  test: { environment: 'node', include: ['test/**/*.test.ts'], exclude: ['test/cli.test.ts', 'node_modules/**'] },
});
